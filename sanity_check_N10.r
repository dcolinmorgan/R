...
N1<-read.table("~/Dropbox/SciLifeLab/PROJECTS/N10_ERIK_check_Bolsco_NESTBOOT_06-Apr-2019.tsv",header=TRUE, sep="\t")
...
ggplot(data=N1,aes(x=SNR,y=pre,colour=method))+geom_line()
