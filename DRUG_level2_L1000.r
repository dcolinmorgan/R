...
# # 
# # idx <- which(TRCN_ds_annotated@cdesc$cell_id == "HT29" & TRCN_ds_annotated@cdesc$pert_time == "96" & TRCN_ds_annotated@cdesc$pert_type=="trt_sh")




idx <- which(TRCN_ds_annotated@cdesc$pert_time == "24"&TRCN_ds_annotated@cdesc$cell_id == "HT29")#|TRCN_ds_annotated@cdesc$cell_id == "HT29"|TRCN_ds_annotated@cdesc$cell_id == "HT29"|TRCN_ds_annotated@cdesc$cell_id == "HCC515"|TRCN_ds_annotated@cdesc$cell_id == "HA1E"|TRCN_ds_annotated@cdesc$cell_id == "A375"|TRCN_ds_annotated@cdesc$cell_id == "VCAP"|TRCN_ds_annotated@cdesc$cell_id == "HT29")
...
HT29SQ <- TRCN_ds_96h_SQ@mat
rownames(HT29SQ)<-TRCN_ds_96h_SQ@rdesc$pr_gene_symbol
colnames(HT29SQ) <- TRCN_ds_96h_SQ@cdesc$FOO.e
...
# idx <- which(EMPTY_ds_annotated@cdesc$cell_id == "HT29" &EMPTY_ds_annotated@cdesc$pert_time == "96"& EMPTY_ds_annotated@cdesc$pert_type=="ctl_vector") # we take only 96 hour empty but is this 
idx <- which(EMPTY_ds_annotated@cdesc$pert_time == "24" & EMPTY_ds_annotated@cdesc$cell_id == "HT29" )#|EMPTY_ds_annotated@cdesc$cell_id == "HT29"|EMPTY_ds_annotated@cdesc$cell_id == "HT29"|EMPTY_ds_annotated@cdesc$cell_id == "HT29"|EMPTY_ds_annotated@cdesc$cell_id == "HCC515"|EMPTY_ds_annotated@cdesc$cell_id == "HA1E"|EMPTY_ds_annotated@cdesc$cell_id == "A375"|EMPTY_ds_annotated@cdesc$cell_id == "VCAP"|EMPTY_ds_annotated@cdesc$cell_id == "HT29")
EMPTY_ds_96h <- subset.gct(EMPTY_ds_annotated, cid=idx)
EMPTY_ds_96h_SQ <- subset.gct(EMPTY_ds_96h, rid=idx2)
zz<-apply(EMPTY_ds_96h_SQ@mat,1,mean) #averaging 449 empty_vectors for HT29
...
write.csv(ww,"drug_HT29_24_Y.csv")
